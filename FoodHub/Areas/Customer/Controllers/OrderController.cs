...
using FoodHub.Models.ViewModels;
using FoodHub.Utility;
...
namespace FoodHub.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "FoodHub - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order is ready for pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "FoodHub - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "FoodHub - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
